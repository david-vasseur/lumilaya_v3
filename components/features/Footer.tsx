...
const Footer = () => {
  ...
  useEffect(() => {
    ...
    // Timeline unique pour tout le footer
    ...
    // Brand
    tl.from(footer.querySelector(".footer-brand"), {
      y: 60,
      opacity: 0,
      duration: 0.8,
      ease: "power1.out",
    ...
    // Social icons
    tl.from(
      footer.querySelectorAll(".footer-social"),
      {
        scale: 0.8,
        opacity: 0,
        duration: 0.5,
    ...
    // Bottom section
    tl.from(footer.querySelector(".footer-bottom"), {
      y: 30,
      opacity: 0,
      duration: 0.6,
      ease: "power1.out",
  ...
  return (
    <footer
      ref={footerRef}
      className="footer relative bg-linear-to-br from-[#7A9B8E] via-[#6A8B7E] to-[#5A7B6E] text-white overflow-hidden"
    >
